.. -*- mode: rst -*-
==========================================
 Keyboards for the Eastern Mari language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Eastern Mari language. The data and implementations
...
* http://giellatekno.uit.no/mhrdoc/index.html
* https://giellalt.uit.no/tools/docu-mhr-manual.html
...
The Eastern Mari keyboard sources can be acquired using the `Giella SVN
